...
abstract class Person {
    constructor(public firstName?: string, public lastName?: string, protected city?: string) {
...
class Customer extends Person {
    constructor(firstName?: string, lastName?: string, city?: string, id?: number) {
...
const customer: PrimeCustomer = new PrimeCustomer("Jane", "Smith", "Los Angeles", 101);
...
const grandChild: GrandChild = new GrandChild();
...
const counter3: Counter = new Counter();
const counter4: Counter = new Counter();
